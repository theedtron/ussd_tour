...
class MenusTableSeeder extends Seeder
{
    public function run()
    {
        /**
         * menu types
         * type 0 - authentication mini app,
         * Type 1 - another menu mini app,
         * type 2 leads to a process app, 3
         * gives information directly
         */
        Eloquent::unguard();
        ...
        DB::table('ussd_menus')->insert(array(
            ...
            array(
                ...
                'is_parent' => 0,
                'type' => 2,
                'confirmation_message' => "Your request has been received and will be processed",
            ),
//            array(
//                'title' => 'TB Info',
//                'is_parent' => 0,
